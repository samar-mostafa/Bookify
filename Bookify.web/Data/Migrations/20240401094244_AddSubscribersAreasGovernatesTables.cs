...
{
    public partial class AddSubscribersAreasGovernatesTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatedOnById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Governorates_AspNetUsers_LastUpdatedOnById",
                        column: x => x.LastUpdatedOnById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Areas_AspNetUsers_LastUpdatedOnById",
                        column: x => x.LastUpdatedOnById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Subscripers_AspNetUsers_LastUpdatedOnById",
                        column: x => x.LastUpdatedOnById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Areas_LastUpdatedOnById",
                table: "Areas",
                column: "LastUpdatedOnById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Governorates_LastUpdatedOnById",
                table: "Governorates",
                column: "LastUpdatedOnById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscripers_LastUpdatedOnById",
                table: "Subscripers",
                column: "LastUpdatedOnById");
